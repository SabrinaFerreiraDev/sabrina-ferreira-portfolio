  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-display tracking-wide",
  {
    variants: {
      variant: {
        ...
        neon: "bg-primary text-primary-foreground border border-primary shadow-[0_0_20px_hsl(330_86%_49%_/_0.5)] hover:shadow-[0_0_30px_hsl(330_86%_49%_/_0.7)] hover:bg-primary/90 transition-all duration-300",
        "neon-outline": "border-2 border-primary bg-transparent text-primary hover:bg-primary/10 shadow-[0_0_15px_hsl(330_86%_49%_/_0.3)] hover:shadow-[0_0_25px_hsl(330_86%_49%_/_0.5)] transition-all duration-300",
        glass: "glass border-primary/30 text-foreground hover:border-primary/50 hover:bg-primary/5",
      },
      size: {
